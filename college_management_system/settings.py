...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "main_app.context_processors.firebase_settings",
            ],
        },
    },
]
...
# Firebase / GCP keys (read from environment variables)
FIREBASE_CONFIG = {
...
# Server key used to send messages from server to FCM (keep this secret)
